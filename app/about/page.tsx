        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="flex gap-6">
              <Link href="/session" className="text-white/70 hover:text-white">Try Session</Link>
              <Link href="/register" className="text-white/70 hover:text-white">Sign Up</Link>
            </nav>
          </div>
        </div>
      </header>
      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        ...
        >
          <div className="text-center mb-12">
            <h1 className="text-5xl font-bold text-white mb-6">About EMDR-AI Therapy</h1>
            <p className="text-xl text-white/80">Revolutionizing mental health care through technology and compassion</p>
          </div>
          ...
          <section className="bg-gradient-to-r from-red-500/20 to-orange-500/20 backdrop-blur-md rounded-3xl p-8 mb-8 border border-white/20">
            ...
            <div className="text-white/80 space-y-4">
              <p className="font-semibold text-white">Warning: EMDR-AI is a wellness tool, not a replacement for professional therapy.</p>
